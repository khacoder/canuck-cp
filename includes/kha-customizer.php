...
function canuckcp_get_customizer_option_partameters() {
	...
	$options = array(
		...
		'canuckcp_use_lazyload'                            => array(
			...
			'option_type' => 'checkbox',
			'description' => esc_html__( 'Click to use this feature. ', 'canuck-cp' ) .
							esc_html__( 'Lazy load delays loading of off screen images and improves page speed.', 'canuck-cp' ),
			'section'     => 'general_jquery',
			'priority'    => 4,
			'default'     => false,
			'transport'   => 'refresh',
		...
		'canuckcp_disable_scrollreveal'                    => array(
			...
			'option_type' => 'checkbox',
			'description' => esc_html__( 'Click to disable this feature. ', 'canuck-cp' ) .
							esc_html__( 'Scroll Reveal is used for home page section animation.', 'canuck-cp' ),
			'section'     => 'general_jquery',
			'priority'    => 5,
			'default'     => false,
			'transport'   => 'refresh',
		...
		'canuckcp_use_social_share'                        => array(
			...
			'option_type' => 'checkbox',
			'description' => esc_html__( 'Use basic social sharing integrated in to the theme.', 'canuck-cp' ),
		...
		'canuckcp_share_on_meta'                           => array(
			'name'        => 'canuckcp_share_on_meta',
			'title'       => esc_html__( 'Social Share on Meta', 'canuck-cp' ),
			'option_type' => 'checkbox',
			'description' => esc_html__( 'Use basic social sharing on the meta of posts.', 'canuck-cp' ),
			'section'     => 'social_share',
			'priority'    => 4,
			'default'     => false,
			'transport'   => 'refresh',
