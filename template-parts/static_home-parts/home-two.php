	...
	<div class="home-2-wide-overlay">
		<div class="home-2-wrap">
			<div class="servicebox one">
				...
				$section2_box1_image_font     = get_theme_mod( 'canuckcp_section2_box1_image_font', 'no icon' );
				...
				$section2_box1_button_icon    = get_theme_mod( 'canuckcp_section2_box1_button_icon', 'no icon' );
			...
			<div class="servicebox two">
				...
				$section2_box2_image_font     = get_theme_mod( 'canuckcp_section2_box2_image_font', 'no icon' );
				...
				$section2_box2_button_icon    = get_theme_mod( 'canuckcp_section2_box2_button_icon', 'no icon' );
			...
			<div class="servicebox three">
				...
				$section2_box3_image_font     = get_theme_mod( 'canuckcp_section2_box3_image_font', 'no icon' );
				...
				$section2_box3_button_icon    = get_theme_mod( 'canuckcp_section2_box3_button_icon', 'no icon' );
