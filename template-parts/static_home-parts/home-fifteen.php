						...
						<div class="section15-graphic">
							<a class="section15-linked-image" href="<?php echo esc_url( $section15_box1_button_link ); ?>">
								...
								if ( true === $use_lazyload ) {
									...
									?>
									<img src="<?php echo esc_url( $section15_box1_image ); ?>" alt="<?php echo esc_attr( $section15_box1_title ); ?>" />
									<?php
								}
								?>
						...
						if ( '' !== $section15_box1_image ) {
							...
							<div class="section15-graphic">
								...
								if ( true === $use_lazyload ) {
									...
									?>
									<img class ="no-link" src="<?php echo esc_url( $section15_box1_image ); ?>" alt="<?php echo esc_attr( $section15_box1_title ); ?>" />
									<?php
								}
								?>
							</div>
						...
						<div class="section15-graphic">
							<a class="section15-linked-image" href="<?php echo esc_url( $section15_box2_button_link ); ?>">
								...
								if ( true === $use_lazyload ) {
									...
									?>
									<img src="<?php echo esc_url( $section15_box2_image ); ?>" alt="<?php echo esc_attr( $section15_box2_title ); ?>" />
									<?php
								}
								?>
								<div class="section15-image-overlay">
						...
						if ( '' !== $section15_box2_image ) {
							...
							<div class="section15-graphic">
								...
								if ( true === $use_lazyload ) {
									...
									?>
									<img class ="no-link" src="<?php echo esc_url( $section15_box2_image ); ?>" alt="<?php echo esc_attr( $section15_box2_title ); ?>" />
									<?php
								}
								?>
							</div>
						...
						<div class="section15-graphic">
							<a class="section15-linked-image" href="<?php echo esc_url( $section15_box3_button_link ); ?>">
								...
								if ( true === $use_lazyload ) {
									...
									?>
									<img src="<?php echo esc_url( $section15_box3_image ); ?>" alt="<?php echo esc_attr( $section15_box3_title ); ?>" />
									<?php
								}
								?>
								<div class="section15-image-overlay">
						...
						if ( '' !== $section15_box3_image ) {
							...
							<div class="section15-graphic">
								...
								if ( true === $use_lazyload ) {
									...
									?>
									<img class ="no-link" src="<?php echo esc_url( $section15_box3_image ); ?>" alt="<?php echo esc_attr( $section15_box3_title ); ?>" />
									<?php
								}
								?>
							</div>
						...
						<div class="section15-graphic">
							<a class="section15-linked-image" href="<?php echo esc_url( $section15_box4_button_link ); ?>">
								...
								if ( true === $use_lazyload ) {
									...
									?>
									<img src="<?php echo esc_url( $section15_box4_image ); ?>" alt="<?php echo esc_attr( $section15_box4_title ); ?>" />
									<?php
								}
								?>
								<div class="section15-image-overlay">
						...
						if ( '' !== $section15_box4_image ) {
							...
							<div class="section15-graphic">
								...
								if ( true === $use_lazyload ) {
									...
									?>
									<img class ="no-link" src="<?php echo esc_url( $section15_box4_image ); ?>" alt="<?php echo esc_attr( $section15_box4_title ); ?>" />
									<?php
								}
								?>
							</div>
