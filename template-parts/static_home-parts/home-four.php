	...
	<div class="home-4-wide-overlay">
		<div class="home-4-wrap">
			<div class="servicebox one">
				...
				$section4_box1_image_font     = get_theme_mod( 'canuckcp_section4_box1_image_font', 'no icon' );
				...
				$section4_box1_button_icon    = get_theme_mod( 'canuckcp_section4_box1_button_icon', 'no icon' );
			...
			<div class="servicebox two">
				...
				$section4_box2_image_font     = get_theme_mod( 'canuckcp_section4_box2_image_font', 'no icon' );
				...
				$section4_box2_button_icon    = get_theme_mod( 'canuckcp_section4_box2_button_icon', 'no icon' );
